...
/******************************************************************************/
    ...
    const commandNameFromElement = elem => {
        while ( elem !== null ) {
    ...
    const captureShortcut = ev => {
        ...
        const keydownHandler = ev => {
            ...
            if ( status === 1 ) {
                ...
                const keyName = validStatus1Keys.get(ev.key.toLowerCase());
                if ( keyName !== undefined ) {
                    after.add(keyName);
                    updateCapturedShortcut();
                    status = 2;
...
/******************************************************************************/
    ...
    vAPI.messaging.send('dashboard', { what: 'getShortcuts' }, commands => {
